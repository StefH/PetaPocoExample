...
//     Connection String:      `data source=(localdb)\MSSQLLocalDB;initial catalog=Northwind;integrated security=True;MultipleActiveResultSets=True;App=EntityFramework`
//     Schema:                 ``
//     Include Views:          `False`
...
namespace PetaPocoExample.Net472.Entities
{

	public partial class Northwind : Database
	{
		public Northwind() 
			: base("Northwind")
		{
		...
		{
			Northwind GetInstance();
		}
		
		public static IFactory Factory { get; set; }
        public static Northwind GetInstance()
        {
			if (_instance!=null)
				return _instance;
		...
		[ThreadStatic] static Northwind _instance;
		...
		{
			public static Northwind repo { get { return Northwind.GetInstance(); } }
    ...
    public partial class Category : Northwind.Record<Category>  
    {
    ...
    public partial class CustomerCustomerDemo : Northwind.Record<CustomerCustomerDemo>  
    {
    ...
    public partial class CustomerDemographic : Northwind.Record<CustomerDemographic>  
    {
    ...
    public partial class Customer : Northwind.Record<Customer>  
    {
    ...
    public partial class Employee : Northwind.Record<Employee>  
    {
    ...
    public partial class EmployeeTerritory : Northwind.Record<EmployeeTerritory>  
    {
    ...
    public partial class Order_Detail : Northwind.Record<Order_Detail>  
    {
    ...
    public partial class Order : Northwind.Record<Order>  
    {
    ...
    public partial class Product : Northwind.Record<Product>  
    {
    ...
    public partial class Region : Northwind.Record<Region>  
    {
    ...
    public partial class Shipper : Northwind.Record<Shipper>  
    {
    ...
    public partial class Supplier : Northwind.Record<Supplier>  
    {
    ...
    public partial class Territory : Northwind.Record<Territory>  
    {
